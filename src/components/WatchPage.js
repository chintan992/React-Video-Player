...
// Add this component above the WatchPage component
    ...
    <div className={`flex items-center justify-between gap-2 mt-4 p-3 rounded-lg ${
      ...
      <motion.button
        ...
        data-tooltip-content={hasPrevious ? 
          `S${season} E${currentEpisodeIndex}: ${episodes[currentEpisodeIndex - 1]?.name}` : 
          'First episode'}
      >
      ...
      <motion.button
        ...
        data-tooltip-content={hasNext ? 
          `S${season} E${currentEpisodeIndex + 2}: ${episodes[currentEpisodeIndex + 1]?.name}` : 
        ...
        <div ref={contentRef} className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mobile:grid-cols-1">
            <div className="lg:col-span-2">
              ...
              {/*Add inside the WatchPage component's return statement, right after VideoSection: */}
                {type === 'tv' && (
                  <EpisodeNavigation
                    episodes={episodes}
