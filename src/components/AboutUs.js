...
const AboutUs = () => {
  ...
  return (
    <div className={`min-h-screen py-12 ${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mission Statement */}
        <div className={`text-center max-w-3xl mx-auto mb-16 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
        ...
        {/* Contact Section */}
        <div className={`text-center max-w-2xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
          <h2 className={`text-3xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            Get in Touch
          </h2>
