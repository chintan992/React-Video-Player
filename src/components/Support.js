...
const Support = () => {
  return (
    <div className="max-w-2xl mx-auto p-8 bg-white shadow-lg rounded-lg">
      <h1 className="text-4xl font-bold text-center text-blue-600 mb-8">Support</h1>
      
      <section className="mb-6">
        <h2 className="text-2xl font-semibold text-blue-500 mb-4">Frequently Asked Questions</h2>
        <ul className="list-disc list-inside">
          <li className="mb-4">
            <h3 className="text-lg font-semibold">How do I use Let's Stream?</h3>
          ...
          <li className="mb-4">
            <h3 className="text-lg font-semibold">Is Let's Stream free to use?</h3>
            <p>Yes, Let's Stream is a free service. We do not charge for access to our platform.</p>
          </li>
          <li className="mb-4">
            <h3 className="text-lg font-semibold">What do I do if a stream isn't working?</h3>
      ...
      <section className="mb-6">
        ...
        <p>If you have any questions or concerns that aren't addressed in our FAQ, please feel free to contact us at <a href="mailto:support@letsstream.netlify.app" className="text-blue-600 underline">support@letsstream.netlify.app</a></p>
      </section>

      <section className="mb-6 bg-gray-100 p-4 rounded-lg">
        <h2 className="text-2xl font-semibold text-blue-500 mb-4">DMCA Disclaimer</h2>
